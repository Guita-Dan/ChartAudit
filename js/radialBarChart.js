function radialBarChart() {
  ...
  var margin = {top: 60, right: 40, bottom: 0, left: 70};
  var barHeight = 100;
  var reverseLayerOrder = true;
  ...
  function initChart(container) {
    var g = d3.select(container)
      .append('svg')
      .style('width', 2.2 * barHeight + margin.left + margin.right + 'px')
      .style('height', 2.2 * barHeight + margin.top + margin.bottom + 'px')
      .append('g')
